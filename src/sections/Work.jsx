...
const projects = [
  ...
  {
    number: "02",
    title: "Wattoke Test Equipment",
    type: "Web Page",
    description:
      "A professional website for showcasing electrical testing equipment and technical solutions.",
    stack: ["React", "Tailwind CSS"],
    stackPrimary: ["React"],
    year: "2026",
    accent: "bg-[#3B82F6]",
    gradient: "from-[#3B82F6]/10 via-[#3B82F6]/5 to-transparent",
    link: "https://www.wattoke.com/",
    color: "#3B82F6",
  },
  {
    number: "03",
    ...
    description:
      "A full-stack service management system built to streamline customer service, repair tracking, and everyday business operations.",
    stack: ["React", "Node.js", "Express", "MongoDB", "Tailwind CSS"],
    stackPrimary: ["React", "Node.js", "Express", "MongoDB"],
    year: "2026",
    accent: "bg-[#A8B5A2]",
...

  {
    ...
    description:
      "A backend foundation for a real-time live chat platform, focused on API development, data management, and real-time communication.",
    stack: ["Node.js", "Express", "MongoDB", "Socket.IO"],
    stackPrimary: ["Node.js", "Express", "MongoDB", "Socket.IO"],
    year: "2025",
    accent: "bg-[#C5B8D9]",
